...
class AnalysisResult(SQLModel, table=True):
    # Stores the results from our AI analysis
    ...
    # We use JSON type to store lists of strings, which is supported by SQLite
...
# This is an API model, not a database table, so `table=True` is not needed.
